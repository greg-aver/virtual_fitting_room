MESSAGES = {
    "hello": """Γεια σας! Είμαι ο εικονικός σας βοηθός για τη δοκιμή ρούχων.
Στείλτε μου τη φωτογραφία σας και τη φωτογραφία των ρούχων, και θα σας βοηθήσω να φανταστείτε
πώς θα φαίνεστε με αυτό το ντύσιμο.
Απλά ακολουθήστε τις υποδείξεις μου — ας δημιουργήσουμε μαζί το τέλειο look!""",
    
    "ask_photo_person": "Παρακαλώ στείλτε τη φωτογραφία σας",
    
    "ask_photo_cloth": "Παρακαλώ στείλτε μου τη φωτογραφία των ρούχων"
}
